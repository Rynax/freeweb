...
CREATE TABLE `freeweb`.`user_detail_info` (
	...
	user_status int(1) not null default 3 COMMENT '用户状态: 0:正常, 1:冻结, 2:删除, 3: 首次登陆',
    primary key (`user_id`),
    key (`nick_name`)
...
INSERT INTO `freeweb`.`user_detail_info` VALUES (1, 'admin', null, 0, null, null, now(), 0);
INSERT INTO `freeweb`.`user_detail_info` VALUES (2, '测试用户', null, 0, null, null, now(), default);

INSERT INTO `freeweb`.`user_info` VALUES (1, 'admin', '21232F297A57A5A743894A0E4A801FC3', 0);
INSERT INTO `freeweb`.`user_info` VALUES (2, '测试用户', '21232F297A57A5A743894A0E4A801FC3', default);
...
INSERT INTO `freeweb`.`shop_info` VALUES (null, 2, '测试商铺', now(), 0);
